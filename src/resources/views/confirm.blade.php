        ...
        <div class="confirm-table">
          <table class="confirm-table__inner">
            ...
            <tr class="confirm-table__row">
              ...
              <td class="confirm-table__text">
                <input type="text" name="content" value="{{ $contact['tel1'] }}", readonly />
                -
                <input type="text" name="content" value="{{ $contact['tel2'] }}", readonly />
                -
                <input type="text" name="content" value="{{ $contact['tel3'] }}", readonly />
              </td>
            </tr>
            ...
            <tr class="confirm-table__row">
              ...
              <td class="confirm-table__select">
                <input option value="{{ $contact['type'] }}" readonly />
              </td>
            </tr>
