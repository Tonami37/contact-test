        ...
        <div class="form__group">
          ...
          <div class="form__group-content">
            <div class="form__input--text">
              <input type="name" name="last_name" placeholder="例：山田" />
              <input type="name" name="first_name" placeholder="例：太郎" />
            </div>
          ...
          <div class="form__group-content">
            <div class="form__input--select">
              <select name="inquiry_type">
                ...
                <option value="type1">問い合わせタイプ1</option>
                <option value="type2">問い合わせタイプ2</option>
                <option value="type3">問い合わせタイプ3</option>
                <!-- 必要な問い合わせタイプを追加 -->
              </select>
              </div>
            <div class="form__error">
